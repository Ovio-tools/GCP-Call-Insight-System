...
describe.skipIf(!hasTestDb)('migration 6 precondition (pre-existing skipped rows)', () => {
  ...
  // cols), and 12 (review_queue active-row invariants) sit above 6, so we roll back 7 migrations
  // (6, 7, 8, 9, 10, 11, 12) to reach the pre-6 schema.
  const MIGRATIONS_ABOVE_6 = 7;
