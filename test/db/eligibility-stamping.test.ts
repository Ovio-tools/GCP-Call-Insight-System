...
describe.skipIf(!hasTestDb)('creation-time retention eligibility stamping (Task 8.1)', () => {
  ...
  it.skipIf(!hasRawTestDb)(
    ...
    async () => {
      ...
      // down 9 rolls back 1782864100001 (grinder_pump service_category) + 1782864100000 (drop
      ...
      // enum) — all stacked above 013 — then 013 itself; the following `up` re-applies all nine,
